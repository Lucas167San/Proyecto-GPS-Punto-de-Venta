 ...
 * @author luxxo
 */
public class JDialogCancelaciones extends javax.swing.JDialog {

    /**
     * Creates new form JDialogAutorizar
     */
    JFramePrincipal frame;
    public JDialogCancelaciones(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JDialogCancelaciones.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JDialogCancelaciones dialog = new JDialogCancelaciones(new javax.swing.JFrame(), true);
