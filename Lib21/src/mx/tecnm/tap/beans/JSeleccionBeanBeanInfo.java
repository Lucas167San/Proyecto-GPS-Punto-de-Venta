 ...
 * @author luxxo
 */
public class JSeleccionBeanBeanInfo extends SimpleBeanInfo {

    // Bean descriptor//GEN-FIRST:BeanDescriptor
    /*lazy BeanDescriptor*/
    private static BeanDescriptor getBdescriptor(){
        BeanDescriptor beanDescriptor = new BeanDescriptor  ( mx.tecnm.tap.beans.JSeleccionBean.class , null ); // NOI18N//GEN-HEADEREND:BeanDescriptor
    ...
    private static final int PROPERTY_butDesSeleccionarTodos = 11;
    private static final int PROPERTY_butDesSeleccionarUno = 12;
    private static final int PROPERTY_butSeleccionarTodos = 13;
    private static final int PROPERTY_butSeleccionarUno = 14;
    private static final int PROPERTY_colorFondo = 15;
    ...
    private static final int PROPERTY_elementosDisponibles = 30;
    private static final int PROPERTY_elementosSeleccionados = 31;
    ...
    private static final int PROPERTY_leyendaTotalDisponibles = 63;
    private static final int PROPERTY_leyendaTotalSeleccionados = 64;
    private static final int PROPERTY_lightweight = 65;
    private static final int PROPERTY_listaDisponibles = 66;
    private static final int PROPERTY_listaSeleccionados = 67;
    ...
    private static final int PROPERTY_tituloDisponibles = 96;
    private static final int PROPERTY_tituloSeleccionados = 97;
    ...
    private static final int PROPERTY_totalDisponibles = 101;
    private static final int PROPERTY_totalSeleccionados = 102;
    ...
    private static PropertyDescriptor[] getPdescriptor(){
        ...
        try {
            properties[PROPERTY_accessibleContext] = new PropertyDescriptor ( "accessibleContext", mx.tecnm.tap.beans.JSeleccionBean.class, "getAccessibleContext", null ); // NOI18N
            properties[PROPERTY_actionMap] = new PropertyDescriptor ( "actionMap", mx.tecnm.tap.beans.JSeleccionBean.class, "getActionMap", "setActionMap" ); // NOI18N
            properties[PROPERTY_alignmentX] = new PropertyDescriptor ( "alignmentX", mx.tecnm.tap.beans.JSeleccionBean.class, "getAlignmentX", "setAlignmentX" ); // NOI18N
            properties[PROPERTY_alignmentY] = new PropertyDescriptor ( "alignmentY", mx.tecnm.tap.beans.JSeleccionBean.class, "getAlignmentY", "setAlignmentY" ); // NOI18N
            properties[PROPERTY_ancestorListeners] = new PropertyDescriptor ( "ancestorListeners", mx.tecnm.tap.beans.JSeleccionBean.class, "getAncestorListeners", null ); // NOI18N
            properties[PROPERTY_autoscrolls] = new PropertyDescriptor ( "autoscrolls", mx.tecnm.tap.beans.JSeleccionBean.class, "getAutoscrolls", "setAutoscrolls" ); // NOI18N
            properties[PROPERTY_background] = new PropertyDescriptor ( "background", mx.tecnm.tap.beans.JSeleccionBean.class, "getBackground", "setBackground" ); // NOI18N
            properties[PROPERTY_backgroundSet] = new PropertyDescriptor ( "backgroundSet", mx.tecnm.tap.beans.JSeleccionBean.class, "isBackgroundSet", null ); // NOI18N
            properties[PROPERTY_baselineResizeBehavior] = new PropertyDescriptor ( "baselineResizeBehavior", mx.tecnm.tap.beans.JSeleccionBean.class, "getBaselineResizeBehavior", null ); // NOI18N
            properties[PROPERTY_border] = new PropertyDescriptor ( "border", mx.tecnm.tap.beans.JSeleccionBean.class, "getBorder", "setBorder" ); // NOI18N
            properties[PROPERTY_bounds] = new PropertyDescriptor ( "bounds", mx.tecnm.tap.beans.JSeleccionBean.class, "getBounds", "setBounds" ); // NOI18N
            properties[PROPERTY_butDesSeleccionarTodos] = new PropertyDescriptor ( "butDesSeleccionarTodos", mx.tecnm.tap.beans.JSeleccionBean.class, "getButDesSeleccionarTodos", "setButDesSeleccionarTodos" ); // NOI18N
            properties[PROPERTY_butDesSeleccionarTodos].setPreferred ( true );
            properties[PROPERTY_butDesSeleccionarTodos].setDisplayName ( "Leyenda del boton DesSeleccionar Todos" );
            properties[PROPERTY_butDesSeleccionarUno] = new PropertyDescriptor ( "butDesSeleccionarUno", mx.tecnm.tap.beans.JSeleccionBean.class, "getButDesSeleccionarUno", "setButDesSeleccionarUno" ); // NOI18N
            properties[PROPERTY_butDesSeleccionarUno].setPreferred ( true );
            properties[PROPERTY_butDesSeleccionarUno].setDisplayName ( "Leyenda DesSeleccionar Uno" );
            properties[PROPERTY_butSeleccionarTodos] = new PropertyDescriptor ( "butSeleccionarTodos", mx.tecnm.tap.beans.JSeleccionBean.class, "getButSeleccionarTodos", "setButSeleccionarTodos" ); // NOI18N
            properties[PROPERTY_butSeleccionarTodos].setPreferred ( true );
            properties[PROPERTY_butSeleccionarTodos].setDisplayName ( "Leyenda Seleccionar Todos" );
            properties[PROPERTY_butSeleccionarUno] = new PropertyDescriptor ( "butSeleccionarUno", mx.tecnm.tap.beans.JSeleccionBean.class, "getButSeleccionarUno", "setButSeleccionarUno" ); // NOI18N
            properties[PROPERTY_butSeleccionarUno].setPreferred ( true );
            properties[PROPERTY_butSeleccionarUno].setDisplayName ( "Leyenda Seleccionar uno" );
            properties[PROPERTY_colorFondo] = new PropertyDescriptor ( "colorFondo", mx.tecnm.tap.beans.JSeleccionBean.class, "getColorFondo", "setColorFondo" ); // NOI18N
            properties[PROPERTY_colorFondo].setPreferred ( true );
            properties[PROPERTY_colorFondo].setDisplayName ( "Color de fondo" );
            properties[PROPERTY_colorFondo].setShortDescription ( "Color para el fondo del componente" );
            properties[PROPERTY_colorModel] = new PropertyDescriptor ( "colorModel", mx.tecnm.tap.beans.JSeleccionBean.class, "getColorModel", null ); // NOI18N
            properties[PROPERTY_component] = new IndexedPropertyDescriptor ( "component", mx.tecnm.tap.beans.JSeleccionBean.class, null, null, "getComponent", null ); // NOI18N
            properties[PROPERTY_componentCount] = new PropertyDescriptor ( "componentCount", mx.tecnm.tap.beans.JSeleccionBean.class, "getComponentCount", null ); // NOI18N
            properties[PROPERTY_componentListeners] = new PropertyDescriptor ( "componentListeners", mx.tecnm.tap.beans.JSeleccionBean.class, "getComponentListeners", null ); // NOI18N
            properties[PROPERTY_componentOrientation] = new PropertyDescriptor ( "componentOrientation", mx.tecnm.tap.beans.JSeleccionBean.class, "getComponentOrientation", "setComponentOrientation" ); // NOI18N
            properties[PROPERTY_componentPopupMenu] = new PropertyDescriptor ( "componentPopupMenu", mx.tecnm.tap.beans.JSeleccionBean.class, "getComponentPopupMenu", "setComponentPopupMenu" ); // NOI18N
            properties[PROPERTY_components] = new PropertyDescriptor ( "components", mx.tecnm.tap.beans.JSeleccionBean.class, "getComponents", null ); // NOI18N
            properties[PROPERTY_containerListeners] = new PropertyDescriptor ( "containerListeners", mx.tecnm.tap.beans.JSeleccionBean.class, "getContainerListeners", null ); // NOI18N
            properties[PROPERTY_cursor] = new PropertyDescriptor ( "cursor", mx.tecnm.tap.beans.JSeleccionBean.class, "getCursor", "setCursor" ); // NOI18N
            properties[PROPERTY_cursorSet] = new PropertyDescriptor ( "cursorSet", mx.tecnm.tap.beans.JSeleccionBean.class, "isCursorSet", null ); // NOI18N
            properties[PROPERTY_debugGraphicsOptions] = new PropertyDescriptor ( "debugGraphicsOptions", mx.tecnm.tap.beans.JSeleccionBean.class, "getDebugGraphicsOptions", "setDebugGraphicsOptions" ); // NOI18N
            properties[PROPERTY_displayable] = new PropertyDescriptor ( "displayable", mx.tecnm.tap.beans.JSeleccionBean.class, "isDisplayable", null ); // NOI18N
            properties[PROPERTY_doubleBuffered] = new PropertyDescriptor ( "doubleBuffered", mx.tecnm.tap.beans.JSeleccionBean.class, "isDoubleBuffered", "setDoubleBuffered" ); // NOI18N
            properties[PROPERTY_dropTarget] = new PropertyDescriptor ( "dropTarget", mx.tecnm.tap.beans.JSeleccionBean.class, "getDropTarget", "setDropTarget" ); // NOI18N
            properties[PROPERTY_elementosDisponibles] = new PropertyDescriptor ( "elementosDisponibles", mx.tecnm.tap.beans.JSeleccionBean.class, "getElementosDisponibles", null ); // NOI18N
            properties[PROPERTY_elementosDisponibles].setHidden ( true );
            properties[PROPERTY_elementosSeleccionados] = new PropertyDescriptor ( "elementosSeleccionados", mx.tecnm.tap.beans.JSeleccionBean.class, "getElementosSeleccionados", null ); // NOI18N
            properties[PROPERTY_elementosSeleccionados].setHidden ( true );
            properties[PROPERTY_enabled] = new PropertyDescriptor ( "enabled", mx.tecnm.tap.beans.JSeleccionBean.class, "isEnabled", "setEnabled" ); // NOI18N
            properties[PROPERTY_focusable] = new PropertyDescriptor ( "focusable", mx.tecnm.tap.beans.JSeleccionBean.class, "isFocusable", "setFocusable" ); // NOI18N
            properties[PROPERTY_focusCycleRoot] = new PropertyDescriptor ( "focusCycleRoot", mx.tecnm.tap.beans.JSeleccionBean.class, "isFocusCycleRoot", "setFocusCycleRoot" ); // NOI18N
            properties[PROPERTY_focusCycleRootAncestor] = new PropertyDescriptor ( "focusCycleRootAncestor", mx.tecnm.tap.beans.JSeleccionBean.class, "getFocusCycleRootAncestor", null ); // NOI18N
            properties[PROPERTY_focusListeners] = new PropertyDescriptor ( "focusListeners", mx.tecnm.tap.beans.JSeleccionBean.class, "getFocusListeners", null ); // NOI18N
            properties[PROPERTY_focusOwner] = new PropertyDescriptor ( "focusOwner", mx.tecnm.tap.beans.JSeleccionBean.class, "isFocusOwner", null ); // NOI18N
            properties[PROPERTY_focusTraversable] = new PropertyDescriptor ( "focusTraversable", mx.tecnm.tap.beans.JSeleccionBean.class, "isFocusTraversable", null ); // NOI18N
            properties[PROPERTY_focusTraversalKeys] = new IndexedPropertyDescriptor ( "focusTraversalKeys", mx.tecnm.tap.beans.JSeleccionBean.class, null, null, null, "setFocusTraversalKeys" ); // NOI18N
            properties[PROPERTY_focusTraversalKeysEnabled] = new PropertyDescriptor ( "focusTraversalKeysEnabled", mx.tecnm.tap.beans.JSeleccionBean.class, "getFocusTraversalKeysEnabled", "setFocusTraversalKeysEnabled" ); // NOI18N
            properties[PROPERTY_focusTraversalPolicy] = new PropertyDescriptor ( "focusTraversalPolicy", mx.tecnm.tap.beans.JSeleccionBean.class, "getFocusTraversalPolicy", "setFocusTraversalPolicy" ); // NOI18N
            properties[PROPERTY_focusTraversalPolicyProvider] = new PropertyDescriptor ( "focusTraversalPolicyProvider", mx.tecnm.tap.beans.JSeleccionBean.class, "isFocusTraversalPolicyProvider", "setFocusTraversalPolicyProvider" ); // NOI18N
            properties[PROPERTY_focusTraversalPolicySet] = new PropertyDescriptor ( "focusTraversalPolicySet", mx.tecnm.tap.beans.JSeleccionBean.class, "isFocusTraversalPolicySet", null ); // NOI18N
            properties[PROPERTY_font] = new PropertyDescriptor ( "font", mx.tecnm.tap.beans.JSeleccionBean.class, "getFont", "setFont" ); // NOI18N
            properties[PROPERTY_fontSet] = new PropertyDescriptor ( "fontSet", mx.tecnm.tap.beans.JSeleccionBean.class, "isFontSet", null ); // NOI18N
            properties[PROPERTY_foreground] = new PropertyDescriptor ( "foreground", mx.tecnm.tap.beans.JSeleccionBean.class, "getForeground", "setForeground" ); // NOI18N
            properties[PROPERTY_foregroundSet] = new PropertyDescriptor ( "foregroundSet", mx.tecnm.tap.beans.JSeleccionBean.class, "isForegroundSet", null ); // NOI18N
            properties[PROPERTY_graphics] = new PropertyDescriptor ( "graphics", mx.tecnm.tap.beans.JSeleccionBean.class, "getGraphics", null ); // NOI18N
            properties[PROPERTY_graphicsConfiguration] = new PropertyDescriptor ( "graphicsConfiguration", mx.tecnm.tap.beans.JSeleccionBean.class, "getGraphicsConfiguration", null ); // NOI18N
            properties[PROPERTY_height] = new PropertyDescriptor ( "height", mx.tecnm.tap.beans.JSeleccionBean.class, "getHeight", null ); // NOI18N
            properties[PROPERTY_hierarchyBoundsListeners] = new PropertyDescriptor ( "hierarchyBoundsListeners", mx.tecnm.tap.beans.JSeleccionBean.class, "getHierarchyBoundsListeners", null ); // NOI18N
            properties[PROPERTY_hierarchyListeners] = new PropertyDescriptor ( "hierarchyListeners", mx.tecnm.tap.beans.JSeleccionBean.class, "getHierarchyListeners", null ); // NOI18N
            properties[PROPERTY_ignoreRepaint] = new PropertyDescriptor ( "ignoreRepaint", mx.tecnm.tap.beans.JSeleccionBean.class, "getIgnoreRepaint", "setIgnoreRepaint" ); // NOI18N
            properties[PROPERTY_inheritsPopupMenu] = new PropertyDescriptor ( "inheritsPopupMenu", mx.tecnm.tap.beans.JSeleccionBean.class, "getInheritsPopupMenu", "setInheritsPopupMenu" ); // NOI18N
            properties[PROPERTY_inputContext] = new PropertyDescriptor ( "inputContext", mx.tecnm.tap.beans.JSeleccionBean.class, "getInputContext", null ); // NOI18N
            properties[PROPERTY_inputMap] = new PropertyDescriptor ( "inputMap", mx.tecnm.tap.beans.JSeleccionBean.class, "getInputMap", null ); // NOI18N
            properties[PROPERTY_inputMethodListeners] = new PropertyDescriptor ( "inputMethodListeners", mx.tecnm.tap.beans.JSeleccionBean.class, "getInputMethodListeners", null ); // NOI18N
            properties[PROPERTY_inputMethodRequests] = new PropertyDescriptor ( "inputMethodRequests", mx.tecnm.tap.beans.JSeleccionBean.class, "getInputMethodRequests", null ); // NOI18N
            properties[PROPERTY_inputVerifier] = new PropertyDescriptor ( "inputVerifier", mx.tecnm.tap.beans.JSeleccionBean.class, "getInputVerifier", "setInputVerifier" ); // NOI18N
            properties[PROPERTY_insets] = new PropertyDescriptor ( "insets", mx.tecnm.tap.beans.JSeleccionBean.class, "getInsets", null ); // NOI18N
            properties[PROPERTY_keyListeners] = new PropertyDescriptor ( "keyListeners", mx.tecnm.tap.beans.JSeleccionBean.class, "getKeyListeners", null ); // NOI18N
            properties[PROPERTY_layout] = new PropertyDescriptor ( "layout", mx.tecnm.tap.beans.JSeleccionBean.class, "getLayout", "setLayout" ); // NOI18N
            properties[PROPERTY_leyendaTotalDisponibles] = new PropertyDescriptor ( "leyendaTotalDisponibles", mx.tecnm.tap.beans.JSeleccionBean.class, "getLeyendaTotalDisponibles", "setLeyendaTotalDisponibles" ); // NOI18N
            properties[PROPERTY_leyendaTotalDisponibles].setPreferred ( true );
            properties[PROPERTY_leyendaTotalDisponibles].setDisplayName ( "Leyenda Total Disponibles" );
            properties[PROPERTY_leyendaTotalDisponibles].setShortDescription ( "Establece la leyenda que se despliega en el total de elementos disponibles" );
            properties[PROPERTY_leyendaTotalSeleccionados] = new PropertyDescriptor ( "leyendaTotalSeleccionados", mx.tecnm.tap.beans.JSeleccionBean.class, "getLeyendaTotalSeleccionados", "setLeyendaTotalSeleccionados" ); // NOI18N
            properties[PROPERTY_leyendaTotalSeleccionados].setPreferred ( true );
            properties[PROPERTY_leyendaTotalSeleccionados].setDisplayName ( "Leyenda Total Seleccionados" );
            properties[PROPERTY_leyendaTotalSeleccionados].setShortDescription ( "Establece la leyenda que se despliega en el total de los elementos seleccionados" );
            properties[PROPERTY_lightweight] = new PropertyDescriptor ( "lightweight", mx.tecnm.tap.beans.JSeleccionBean.class, "isLightweight", null ); // NOI18N
            properties[PROPERTY_listaDisponibles] = new PropertyDescriptor ( "listaDisponibles", mx.tecnm.tap.beans.JSeleccionBean.class, "getListaDisponibles", "setListaDisponibles" ); // NOI18N
            properties[PROPERTY_listaDisponibles].setPreferred ( true );
            properties[PROPERTY_listaDisponibles].setDisplayName ( "Elementos disponibles" );
            properties[PROPERTY_listaDisponibles].setShortDescription ( "Es la lista de los elementos que se pueden escoger" );
            properties[PROPERTY_listaSeleccionados] = new PropertyDescriptor ( "listaSeleccionados", mx.tecnm.tap.beans.JSeleccionBean.class, "getListaSeleccionados", "setListaSeleccionados" ); // NOI18N
            properties[PROPERTY_listaSeleccionados].setPreferred ( true );
            properties[PROPERTY_listaSeleccionados].setDisplayName ( "Elementos Seleccionados" );
            properties[PROPERTY_listaSeleccionados].setShortDescription ( "Es la lista de los elementos que han sido escogidos" );
            properties[PROPERTY_locale] = new PropertyDescriptor ( "locale", mx.tecnm.tap.beans.JSeleccionBean.class, "getLocale", "setLocale" ); // NOI18N
            properties[PROPERTY_location] = new PropertyDescriptor ( "location", mx.tecnm.tap.beans.JSeleccionBean.class, "getLocation", "setLocation" ); // NOI18N
            properties[PROPERTY_locationOnScreen] = new PropertyDescriptor ( "locationOnScreen", mx.tecnm.tap.beans.JSeleccionBean.class, "getLocationOnScreen", null ); // NOI18N
            properties[PROPERTY_managingFocus] = new PropertyDescriptor ( "managingFocus", mx.tecnm.tap.beans.JSeleccionBean.class, "isManagingFocus", null ); // NOI18N
            properties[PROPERTY_maximumSize] = new PropertyDescriptor ( "maximumSize", mx.tecnm.tap.beans.JSeleccionBean.class, "getMaximumSize", "setMaximumSize" ); // NOI18N
            properties[PROPERTY_maximumSizeSet] = new PropertyDescriptor ( "maximumSizeSet", mx.tecnm.tap.beans.JSeleccionBean.class, "isMaximumSizeSet", null ); // NOI18N
            properties[PROPERTY_minimumSize] = new PropertyDescriptor ( "minimumSize", mx.tecnm.tap.beans.JSeleccionBean.class, "getMinimumSize", "setMinimumSize" ); // NOI18N
            properties[PROPERTY_minimumSizeSet] = new PropertyDescriptor ( "minimumSizeSet", mx.tecnm.tap.beans.JSeleccionBean.class, "isMinimumSizeSet", null ); // NOI18N
            properties[PROPERTY_mixingCutoutShape] = new PropertyDescriptor ( "mixingCutoutShape", mx.tecnm.tap.beans.JSeleccionBean.class, null, "setMixingCutoutShape" ); // NOI18N
            properties[PROPERTY_mouseListeners] = new PropertyDescriptor ( "mouseListeners", mx.tecnm.tap.beans.JSeleccionBean.class, "getMouseListeners", null ); // NOI18N
            properties[PROPERTY_mouseMotionListeners] = new PropertyDescriptor ( "mouseMotionListeners", mx.tecnm.tap.beans.JSeleccionBean.class, "getMouseMotionListeners", null ); // NOI18N
            properties[PROPERTY_mousePosition] = new PropertyDescriptor ( "mousePosition", mx.tecnm.tap.beans.JSeleccionBean.class, "getMousePosition", null ); // NOI18N
            properties[PROPERTY_mouseWheelListeners] = new PropertyDescriptor ( "mouseWheelListeners", mx.tecnm.tap.beans.JSeleccionBean.class, "getMouseWheelListeners", null ); // NOI18N
            properties[PROPERTY_name] = new PropertyDescriptor ( "name", mx.tecnm.tap.beans.JSeleccionBean.class, "getName", "setName" ); // NOI18N
            properties[PROPERTY_nextFocusableComponent] = new PropertyDescriptor ( "nextFocusableComponent", mx.tecnm.tap.beans.JSeleccionBean.class, "getNextFocusableComponent", "setNextFocusableComponent" ); // NOI18N
            properties[PROPERTY_opaque] = new PropertyDescriptor ( "opaque", mx.tecnm.tap.beans.JSeleccionBean.class, "isOpaque", "setOpaque" ); // NOI18N
            properties[PROPERTY_optimizedDrawingEnabled] = new PropertyDescriptor ( "optimizedDrawingEnabled", mx.tecnm.tap.beans.JSeleccionBean.class, "isOptimizedDrawingEnabled", null ); // NOI18N
            properties[PROPERTY_paintingForPrint] = new PropertyDescriptor ( "paintingForPrint", mx.tecnm.tap.beans.JSeleccionBean.class, "isPaintingForPrint", null ); // NOI18N
            properties[PROPERTY_paintingTile] = new PropertyDescriptor ( "paintingTile", mx.tecnm.tap.beans.JSeleccionBean.class, "isPaintingTile", null ); // NOI18N
            properties[PROPERTY_parent] = new PropertyDescriptor ( "parent", mx.tecnm.tap.beans.JSeleccionBean.class, "getParent", null ); // NOI18N
            properties[PROPERTY_preferredSize] = new PropertyDescriptor ( "preferredSize", mx.tecnm.tap.beans.JSeleccionBean.class, "getPreferredSize", "setPreferredSize" ); // NOI18N
            properties[PROPERTY_preferredSizeSet] = new PropertyDescriptor ( "preferredSizeSet", mx.tecnm.tap.beans.JSeleccionBean.class, "isPreferredSizeSet", null ); // NOI18N
            properties[PROPERTY_propertyChangeListeners] = new PropertyDescriptor ( "propertyChangeListeners", mx.tecnm.tap.beans.JSeleccionBean.class, "getPropertyChangeListeners", null ); // NOI18N
            properties[PROPERTY_registeredKeyStrokes] = new PropertyDescriptor ( "registeredKeyStrokes", mx.tecnm.tap.beans.JSeleccionBean.class, "getRegisteredKeyStrokes", null ); // NOI18N
            properties[PROPERTY_requestFocusEnabled] = new PropertyDescriptor ( "requestFocusEnabled", mx.tecnm.tap.beans.JSeleccionBean.class, "isRequestFocusEnabled", "setRequestFocusEnabled" ); // NOI18N
            properties[PROPERTY_rootPane] = new PropertyDescriptor ( "rootPane", mx.tecnm.tap.beans.JSeleccionBean.class, "getRootPane", null ); // NOI18N
            properties[PROPERTY_showing] = new PropertyDescriptor ( "showing", mx.tecnm.tap.beans.JSeleccionBean.class, "isShowing", null ); // NOI18N
            properties[PROPERTY_size] = new PropertyDescriptor ( "size", mx.tecnm.tap.beans.JSeleccionBean.class, "getSize", "setSize" ); // NOI18N
            properties[PROPERTY_tituloDisponibles] = new PropertyDescriptor ( "tituloDisponibles", mx.tecnm.tap.beans.JSeleccionBean.class, "getTituloDisponibles", "setTituloDisponibles" ); // NOI18N
            properties[PROPERTY_tituloDisponibles].setPreferred ( true );
            properties[PROPERTY_tituloDisponibles].setDisplayName ( "Leyenda Disponibles" );
            properties[PROPERTY_tituloDisponibles].setShortDescription ( "Establece el valor de la etiqueta disponibles" );
            properties[PROPERTY_tituloSeleccionados] = new PropertyDescriptor ( "tituloSeleccionados", mx.tecnm.tap.beans.JSeleccionBean.class, "getTituloSeleccionados", "setTituloSeleccionados" ); // NOI18N
            properties[PROPERTY_tituloSeleccionados].setPreferred ( true );
            properties[PROPERTY_tituloSeleccionados].setDisplayName ( "Leyenda Seleccionados" );
            properties[PROPERTY_tituloSeleccionados].setShortDescription ( "Establece el valor de la etiqueta seleccionados" );
            properties[PROPERTY_toolkit] = new PropertyDescriptor ( "toolkit", mx.tecnm.tap.beans.JSeleccionBean.class, "getToolkit", null ); // NOI18N
            properties[PROPERTY_toolTipText] = new PropertyDescriptor ( "toolTipText", mx.tecnm.tap.beans.JSeleccionBean.class, "getToolTipText", "setToolTipText" ); // NOI18N
            properties[PROPERTY_topLevelAncestor] = new PropertyDescriptor ( "topLevelAncestor", mx.tecnm.tap.beans.JSeleccionBean.class, "getTopLevelAncestor", null ); // NOI18N
            properties[PROPERTY_totalDisponibles] = new PropertyDescriptor ( "totalDisponibles", mx.tecnm.tap.beans.JSeleccionBean.class, "getTotalDisponibles", null ); // NOI18N
            properties[PROPERTY_totalDisponibles].setHidden ( true );
            properties[PROPERTY_totalSeleccionados] = new PropertyDescriptor ( "totalSeleccionados", mx.tecnm.tap.beans.JSeleccionBean.class, "getTotalSeleccionados", null ); // NOI18N
            properties[PROPERTY_totalSeleccionados].setHidden ( true );
            properties[PROPERTY_transferHandler] = new PropertyDescriptor ( "transferHandler", mx.tecnm.tap.beans.JSeleccionBean.class, "getTransferHandler", "setTransferHandler" ); // NOI18N
            properties[PROPERTY_treeLock] = new PropertyDescriptor ( "treeLock", mx.tecnm.tap.beans.JSeleccionBean.class, "getTreeLock", null ); // NOI18N
            properties[PROPERTY_UI] = new PropertyDescriptor ( "UI", mx.tecnm.tap.beans.JSeleccionBean.class, "getUI", "setUI" ); // NOI18N
            properties[PROPERTY_UIClassID] = new PropertyDescriptor ( "UIClassID", mx.tecnm.tap.beans.JSeleccionBean.class, "getUIClassID", null ); // NOI18N
            properties[PROPERTY_valid] = new PropertyDescriptor ( "valid", mx.tecnm.tap.beans.JSeleccionBean.class, "isValid", null ); // NOI18N
            properties[PROPERTY_validateRoot] = new PropertyDescriptor ( "validateRoot", mx.tecnm.tap.beans.JSeleccionBean.class, "isValidateRoot", null ); // NOI18N
            properties[PROPERTY_verifyInputWhenFocusTarget] = new PropertyDescriptor ( "verifyInputWhenFocusTarget", mx.tecnm.tap.beans.JSeleccionBean.class, "getVerifyInputWhenFocusTarget", "setVerifyInputWhenFocusTarget" ); // NOI18N
            properties[PROPERTY_vetoableChangeListeners] = new PropertyDescriptor ( "vetoableChangeListeners", mx.tecnm.tap.beans.JSeleccionBean.class, "getVetoableChangeListeners", null ); // NOI18N
            properties[PROPERTY_visible] = new PropertyDescriptor ( "visible", mx.tecnm.tap.beans.JSeleccionBean.class, "isVisible", "setVisible" ); // NOI18N
            properties[PROPERTY_visibleRect] = new PropertyDescriptor ( "visibleRect", mx.tecnm.tap.beans.JSeleccionBean.class, "getVisibleRect", null ); // NOI18N
            properties[PROPERTY_width] = new PropertyDescriptor ( "width", mx.tecnm.tap.beans.JSeleccionBean.class, "getWidth", null ); // NOI18N
            properties[PROPERTY_x] = new PropertyDescriptor ( "x", mx.tecnm.tap.beans.JSeleccionBean.class, "getX", null ); // NOI18N
            properties[PROPERTY_y] = new PropertyDescriptor ( "y", mx.tecnm.tap.beans.JSeleccionBean.class, "getY", null ); // NOI18N
        }
    ...
    private static EventSetDescriptor[] getEdescriptor(){
        ...
        try {
            eventSets[EVENT_ancestorListener] = new EventSetDescriptor ( mx.tecnm.tap.beans.JSeleccionBean.class, "ancestorListener", javax.swing.event.AncestorListener.class, new String[] {"ancestorAdded", "ancestorRemoved", "ancestorMoved"}, "addAncestorListener", "removeAncestorListener" ); // NOI18N
            eventSets[EVENT_componentListener] = new EventSetDescriptor ( mx.tecnm.tap.beans.JSeleccionBean.class, "componentListener", java.awt.event.ComponentListener.class, new String[] {"componentResized", "componentMoved", "componentShown", "componentHidden"}, "addComponentListener", "removeComponentListener" ); // NOI18N
            eventSets[EVENT_containerListener] = new EventSetDescriptor ( mx.tecnm.tap.beans.JSeleccionBean.class, "containerListener", java.awt.event.ContainerListener.class, new String[] {"componentAdded", "componentRemoved"}, "addContainerListener", "removeContainerListener" ); // NOI18N
            eventSets[EVENT_focusListener] = new EventSetDescriptor ( mx.tecnm.tap.beans.JSeleccionBean.class, "focusListener", java.awt.event.FocusListener.class, new String[] {"focusGained", "focusLost"}, "addFocusListener", "removeFocusListener" ); // NOI18N
            eventSets[EVENT_hierarchyBoundsListener] = new EventSetDescriptor ( mx.tecnm.tap.beans.JSeleccionBean.class, "hierarchyBoundsListener", java.awt.event.HierarchyBoundsListener.class, new String[] {"ancestorMoved", "ancestorResized"}, "addHierarchyBoundsListener", "removeHierarchyBoundsListener" ); // NOI18N
            eventSets[EVENT_hierarchyListener] = new EventSetDescriptor ( mx.tecnm.tap.beans.JSeleccionBean.class, "hierarchyListener", java.awt.event.HierarchyListener.class, new String[] {"hierarchyChanged"}, "addHierarchyListener", "removeHierarchyListener" ); // NOI18N
            eventSets[EVENT_inputMethodListener] = new EventSetDescriptor ( mx.tecnm.tap.beans.JSeleccionBean.class, "inputMethodListener", java.awt.event.InputMethodListener.class, new String[] {"inputMethodTextChanged", "caretPositionChanged"}, "addInputMethodListener", "removeInputMethodListener" ); // NOI18N
            eventSets[EVENT_keyListener] = new EventSetDescriptor ( mx.tecnm.tap.beans.JSeleccionBean.class, "keyListener", java.awt.event.KeyListener.class, new String[] {"keyTyped", "keyPressed", "keyReleased"}, "addKeyListener", "removeKeyListener" ); // NOI18N
            eventSets[EVENT_mouseListener] = new EventSetDescriptor ( mx.tecnm.tap.beans.JSeleccionBean.class, "mouseListener", java.awt.event.MouseListener.class, new String[] {"mouseClicked", "mousePressed", "mouseReleased", "mouseEntered", "mouseExited"}, "addMouseListener", "removeMouseListener" ); // NOI18N
            eventSets[EVENT_mouseMotionListener] = new EventSetDescriptor ( mx.tecnm.tap.beans.JSeleccionBean.class, "mouseMotionListener", java.awt.event.MouseMotionListener.class, new String[] {"mouseDragged", "mouseMoved"}, "addMouseMotionListener", "removeMouseMotionListener" ); // NOI18N
            eventSets[EVENT_mouseWheelListener] = new EventSetDescriptor ( mx.tecnm.tap.beans.JSeleccionBean.class, "mouseWheelListener", java.awt.event.MouseWheelListener.class, new String[] {"mouseWheelMoved"}, "addMouseWheelListener", "removeMouseWheelListener" ); // NOI18N
            eventSets[EVENT_propertyChangeListener] = new EventSetDescriptor ( mx.tecnm.tap.beans.JSeleccionBean.class, "propertyChangeListener", java.beans.PropertyChangeListener.class, new String[] {"propertyChange"}, "addPropertyChangeListener", "removePropertyChangeListener" ); // NOI18N
            eventSets[EVENT_vetoableChangeListener] = new EventSetDescriptor ( mx.tecnm.tap.beans.JSeleccionBean.class, "vetoableChangeListener", java.beans.VetoableChangeListener.class, new String[] {"vetoableChange"}, "addVetoableChangeListener", "removeVetoableChangeListener" ); // NOI18N
        }
        catch(IntrospectionException e) {
            e.printStackTrace();
    ...
    public BeanInfo[] getAdditionalBeanInfo() {//GEN-FIRST:Superclass
        Class superclass = mx.tecnm.tap.beans.JSeleccionBean.class.getSuperclass();
        BeanInfo sbi = null;
        try {
